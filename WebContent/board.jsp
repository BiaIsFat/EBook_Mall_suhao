	...
	<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页
		...
		<div class="mt-20">
				<table class="table table-border table-bordered table-bg table-hover table-sort">
					...
					<tbody>
					<% 
                         if(option.equals("allsearchboard"))
                         {
                          
                         %>
                       <%
                          List<Board> alllist= (List)request.getAttribute("alllist");
                       ...
                       %>
							  ...
							  <a style="text-decoration:none" class="ml-5" onClick='window.location.href="<%=basepath%>modify.jsp?board_id=<%=board.getId()%>&board_context=<%=board.getContext()%>&board_time=<%=board.getDate() %>"' href="javascript:;" title="修改"><i class="Hui-iconfont">&#xe6df;</i></a>
							  <a style="text-decoration:none" class="ml-5" onClick='window.location.href="<%=basepath%>Managerservlet?option=deleteboard&board_id=<%=board.getId()%>"' href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
                        	  </tr>
                       ...
                       %>
                        	  ...
                        	  <td><%=board.getDate() %></td>
                        	  <td class="f-14 td-manage">
							  <a style="text-decoration:none" class="ml-5" onClick='window.location.href="<%=basepath%>modifyboard.jsp?&board_id=<%=board.getId()%>&board_context=<%=board.getContext()%>&board_time=<%=board.getDate() %>"' href="javascript:;" title="修改"><i class="Hui-iconfont">&#xe6df;</i></a>
							  <a style="text-decoration:none" class="ml-5" onClick='window.location.href="<%=basepath%>Managerservlet?option=deleteboard&board_id=<%=board.getId()%>"' href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
                        	  </tr>
                         <% 
                          }
